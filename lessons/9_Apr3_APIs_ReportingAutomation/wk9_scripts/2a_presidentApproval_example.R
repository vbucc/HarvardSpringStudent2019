...
trumpApproval <- subset(trumpApproval, trumpApproval$subgroup == 'All polls' & trumpApproval$future == F)
disapprove <- ts(trumpApproval$disapprove_estimate, start = c(2017, 23), frequency = 365)
